...
// int [] AverageCol(int[,] arr)                          //вариант  1. Создаем массив значений. Можно работать дальше.
// {
//     int [] averages = new int[arr.GetLength(1)];
//     for (int i = 0; i < arr.GetLength(1); i++)
//     {
//         for (int j = 0; j < arr.GetLength(0); j++)
//             averages[i] = arr[j, i] + averages[i];
//     }
//     return averages;
// }
...
void AverageCol(int[,] arr)                          //вариант  2. Просто выводим среднее арифметическое.
{
    for (int i = 0; i < arr.GetLength(1); i++)
    {
        ...
        Console.WriteLine($"Среднее арифметическое столбца {i + 1} равно {averages}");
    }
}
